...
describe("BatchManagement Component", () => {
  ...
  test("clicking Add Batch navigates to add page", async () => {
    ...
    expect(mockNavigate).toHaveBeenCalledWith("/owner/batches/add");
  });
  ...
  test("clicking Edit navigates to edit page", async () => {
    ...
    expect(mockNavigate).toHaveBeenCalledWith("/owner/batches/edit/1");
  });
  ...
  test("clicking View navigates to view page", async () => {
    ...
    expect(mockNavigate).toHaveBeenCalledWith("/owner/batches/view/1");
  });
