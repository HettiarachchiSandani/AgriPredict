  ...
  return (
    <div className="buyers-wrapper">
      <div className="buyers-tabs">
        <NavLink to="/owner/buyers" className="buyer-tab">Buyers List</NavLink>
        <NavLink to="/owner/buyers/request" className="buyer-tab">Buyer Requests</NavLink>
        <NavLink to="/owner/buyers/order-history" className="buyer-tab">Buyer History</NavLink>
      </div>
      ...
      <div className="buyers-filters">
        ...
        <button className="add-button" onClick={() => navigate("/owner/buyers/add")}>
